  ...
  return (
    <div className="min-h-screen bg-black text-white p-10 flex flex-col items-center">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-20">
         <h1 className="text-5xl font-display font-bold tracking-tighter italic mb-2">BHAGAT GROUP</h1>
         <p className="text-[10px] font-black uppercase tracking-[0.4em] opacity-40">Hospitality Management System v4.0</p>
      </motion.div>
